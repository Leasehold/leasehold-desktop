    ...
    return (
      <Dialog hasClose>
        ...
        <Dialog.Description>
          <p>
            {
              t('We would like to request permission for collecting anonymous data in order to improve our UI products. The data will be stored in our servers however, it will not include sensitive information related to your Leasehold Account.')
            }
          </p>
        </Dialog.Description>
        <Dialog.Description>
