  ...
  componentDidUpdate() {
    ...
    const timeoutProps = {
      ...
      complete: {
        ...
        description: t('Your session was timed out after 10 minutes of no network activity. You may continue to use certain sections of your Leasehold Hub or sign back in to access everything.'),
        options: [{
